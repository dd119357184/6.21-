...
$requirements = array(
    array(
        'PHP 版本',
        true,
        version_compare(PHP_VERSION, "5.2.0", ">=") && version_compare(PHP_VERSION, "7.3.0", "<") ,
        'PHP 5.2 ~ 7.2',
        PHP_VERSION,
    ),
	array(
...
#checkcaiji b{color:red}
        ...
        <div style="width: 682px; margin: 10px auto">
			<p align="center" style="font:25px Arial,微软雅黑,宋体;">小旋风seo服务器环境探测</p>
			<hr color="#ccc" size=1>
            <h4>检查结果</h4>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="1" class="buy_box">
				...
				<tr class="text">
					...
					<td><?php
                            ...
                            ?><?php echo $requirement[2] ? $requirement[3] : $errorInfo . '<a href="http://www.xxfseo.com/" target="_blank">解决方法</a>'; ?></td>
				</tr>
                <?php endforeach; ?>
