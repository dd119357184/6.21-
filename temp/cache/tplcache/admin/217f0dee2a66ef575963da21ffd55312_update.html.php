...
<div class="update_box">
	...
	<div class="inbox" id="inbox">
		...
		<button type="button" id="check" class="button button_success" ><i class="typcn typcn-weather-cloudy"></i> 检查更新</button>
	</div>
</div>
...
$(function() {
	$("#update").click(function(){
		...
		$.ajax({
			url:"<?php echo url('admin/update/update'); ?>",
			dataType:'json',
			timeout:2800000,
			global:false,
	...
	$("#check").click(function(){
		...
		$("#check").hide();
		$.ajax({
			url:"<?php echo url('admin/update/check'); ?>",
			dataType:'json',
			timeout:28000,
			global:false,
			success:function(data){
