...
<form method="post">
		<div id="login">
				<dl>
					...
					<dd style="margin-left:45px"><button type="submit" id="dologin" class="button button_submit">登录</button><a href="javascript:repass();">忘记密码？</a></dd>
				</dl>
