...
?>
	<tr onmouseover=this.bgColor='#EDF8FE'; onmouseout=this.bgColor='#ffffff'; bgcolor='#ffffff'>
	  ...
	  <td align="center"><?php echo empty($this->_var['vo']['tplfiles']) ? 'index,list,show' : $this->_var['vo']['tplfiles']; ?></td>
...
function typeExport(id,title){
	art.dialog.open('?admin-arctype-export-id-'+id,{lock:true,title:'规则导出 ['+title+', ID:'+id+']',id:'nodeTestifrm',width:'700px',height:'400px'});
}
</script>
</body>
</html>