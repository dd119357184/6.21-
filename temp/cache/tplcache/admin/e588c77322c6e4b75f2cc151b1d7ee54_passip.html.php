...
<tr>
	...
	<td class="icheck_radios">
		<label><input type="radio" name="con[web_passip]" value="1"<?php if($this->_var['web_passip']): ?> checked<?php endif; ?>>开启</label>
		<label><input type="radio" name="con[web_passip]" value="0"<?php if(! $this->_var['web_passip']): ?> checked<?php endif; ?>>关闭</label>
	</td>
</tr>
<tr class="list">
  <td align="right">
  ...
  <td><textarea name="con[web_passip_list]" type="text" style="height:350px;width:400px;"><?php echo $this->_var['web_passip_list']; ?></textarea></td>
</tr>
<tr >
	  <td>&nbsp;</td>
...
$("#dosave").click(function(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo url('admin/passip/update'); ?>",
		data:$("form").serialize(),
		dataType:'json',
		timeout:28000,
		global:false,
